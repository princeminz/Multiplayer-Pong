...
class Network:
    ...
    def get_data(self):
        ...
        while 1:
            try:
                ...
                print("player_match_status network: ", self.player_match_status)
            except:
                print('fetch failed!')
            clock.tick(60)
    ...
    def __init__(self) -> None:
        ...
        # self.client.register_event_handler("sendBallPosition", get_ball_position)
        self.client.dispatch_event("register")
        pygase_thread = threading.Thread(target=self.get_data)
        pygase_thread.start()
